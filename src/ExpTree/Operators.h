...
OP_DEF(SIN, 0b001, 0x6E6973 /* 'nis' */, MUL(COS(C(R)), D(R)))

OP_DEF(COS, 0b000, 0x736F63 /* 'soc' */, MUL(MUL(CONST(-1), SIN(C(R))), D(R)))

OP_DEF(TAN, 0b001, 0x006774 /* 'gt'  */, DIV(               D(R) , POW(COS(C(R)), CONST(2))))

OP_DEF(COT, 0b000, 0x677463 /* 'gtc' */, DIV(MUL(CONST(-1), D(R)), POW(SIN(C(R)), CONST(2))))

OP_DEF(ABS, 0b001, 0x736261 /* 'sba' */, MUL(DIV(ABS(C(R)), C(R)), D(R)))

OP_DEF(LN , 0b000, 0x006E6C /* 'nl'  */, DIV(D(R), C(R)))
