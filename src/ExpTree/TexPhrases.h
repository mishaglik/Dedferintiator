...
const char TEX_INIT[] = "\\documentclass{report}\n"
                        ...
                        "\\end{center}\n"
                        "\\vspace*{\\fill}\n"
                        "Дорогой читатель, читая эту *** ты и представить себе не можешь сколько \\sout{боли и страданий} удовольствия ты получишь в результате прочтения.\n"
                        ...
                        "\n"
                        "Прочтя эту \\%!@* ты осознаешь, почему не стоит трать время впустую...\n"
                        "\n"
                        "\\begin{flushright}\n"
...
const char TEX_CHAPTER_1[] = "\\chapter{Матчасть}\n"
                             "\\epigraph{\\textit{А прежде всего матчасть...}}{Народная мудрость}\n"
                             "\\section{О числах}\n"
                             ...
                             "$$\n"
                             "Слева целое число, как сумма целых. А вот справа нет. Паладокс.\n"
                             "Вообще нам за глаза хватает целых чисел. Но вот открою вам страшную тайну. Нет никакой неодходимости вводить другие.\n"
